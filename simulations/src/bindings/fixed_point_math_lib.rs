...
pub mod fixed_point_math_lib {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("OutOfDomain"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned("OutOfDomain"),
                            inputs: ::std::vec![],
                        },
                    ],
                ),
                ...
                (
                    ::std::borrow::ToOwned::to_owned("SDivWadFailed"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned("SDivWadFailed"),
                            inputs: ::std::vec![],
                        },
                    ],
                ),
                (
                    ::std::borrow::ToOwned::to_owned("SMulWadFailed"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned("SMulWadFailed"),
                            inputs: ::std::vec![],
                        },
                    ],
                ),
    ...
    ///Custom Error type `OutOfDomain` with signature `OutOfDomain()` and selector `0xf2b402bb`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(name = "OutOfDomain", abi = "OutOfDomain()")]
    ...
    ///Custom Error type `SDivWadFailed` with signature `SDivWadFailed()` and selector `0x5c43740d`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(name = "SDivWadFailed", abi = "SDivWadFailed()")]
    pub struct SDivWadFailed;
    ///Custom Error type `SMulWadFailed` with signature `SMulWadFailed()` and selector `0xedcd4dd4`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(name = "SMulWadFailed", abi = "SMulWadFailed()")]
    ...
    impl ::ethers::core::abi::AbiDecode for FixedPointMathLibErrors {
        fn decode(
            ...
            if let Ok(decoded) = <DivFailed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::DivFailed(decoded));
            }
            if let Ok(decoded) = <DivWadFailed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::DivWadFailed(decoded));
            }
            if let Ok(decoded) = <ExpOverflow as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ExpOverflow(decoded));
            }
            if let Ok(decoded) = <FactorialOverflow as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::FactorialOverflow(decoded));
            }
            if let Ok(decoded) = <FullMulDivFailed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::FullMulDivFailed(decoded));
            }
            if let Ok(decoded) = <LnWadUndefined as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::LnWadUndefined(decoded));
            }
            if let Ok(decoded) = <MantissaOverflow as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::MantissaOverflow(decoded));
            }
            if let Ok(decoded) = <MulDivFailed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::MulDivFailed(decoded));
            }
            if let Ok(decoded) = <MulWadFailed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::MulWadFailed(decoded));
            }
            if let Ok(decoded) = <OutOfDomain as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::OutOfDomain(decoded));
            }
            if let Ok(decoded) = <RPowOverflow as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::RPowOverflow(decoded));
            }
            if let Ok(decoded) = <SDivWadFailed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SDivWadFailed(decoded));
            }
            if let Ok(decoded) = <SMulWadFailed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SMulWadFailed(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for FixedPointMathLibErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::OutOfDomain(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::RPowOverflow(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::SDivWadFailed(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::SMulWadFailed(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::ethers::contract::ContractRevert for FixedPointMathLibErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector
                    == <MantissaOverflow as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ if selector
                ...
                _ if selector
                    == <OutOfDomain as ::ethers::contract::EthError>::selector() => true,
                _ if selector
                    == <RPowOverflow as ::ethers::contract::EthError>::selector() => true,
                _ if selector
                    == <SDivWadFailed as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ if selector
                    == <SMulWadFailed as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ => false,
            }
    ...
    impl ::core::fmt::Display for FixedPointMathLibErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::OutOfDomain(element) => ::core::fmt::Display::fmt(element, f),
                Self::RPowOverflow(element) => ::core::fmt::Display::fmt(element, f),
                Self::SDivWadFailed(element) => ::core::fmt::Display::fmt(element, f),
                Self::SMulWadFailed(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<OutOfDomain> for FixedPointMathLibErrors {
        fn from(value: OutOfDomain) -> Self {
            Self::OutOfDomain(value)
        }
    }
    ...
    impl ::core::convert::From<SDivWadFailed> for FixedPointMathLibErrors {
        fn from(value: SDivWadFailed) -> Self {
            Self::SDivWadFailed(value)
        }
    }
    impl ::core::convert::From<SMulWadFailed> for FixedPointMathLibErrors {
        fn from(value: SMulWadFailed) -> Self {
            Self::SMulWadFailed(value)
        }
    }
}
