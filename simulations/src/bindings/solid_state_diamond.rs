...
pub mod solid_state_diamond {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("ERC165Base__InvalidInterfaceId"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned(
    ...
    pub static SOLIDSTATEDIAMOND_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct SolidStateDiamond<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for SolidStateDiamond<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for SolidStateDiamond<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for SolidStateDiamond<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for SolidStateDiamond<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(SolidStateDiamond))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> SolidStateDiamond<M> {
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            SolidStateDiamondEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for SolidStateDiamond<M> {
    ...
    ///Custom Error type `ERC165Base__InvalidInterfaceId` with signature `ERC165Base__InvalidInterfaceId()` and selector `0xb0a19dd5`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(
        ...
        abi = "ERC165Base__InvalidInterfaceId()"
    )]
    pub struct ERC165Base__InvalidInterfaceId;
    ...
    pub enum SolidStateDiamondErrors {
        DiamondWritable__InvalidInitializationParameters(
            DiamondWritable__InvalidInitializationParameters,
        ),
        DiamondWritable__RemoveTargetNotZeroAddress(
        ...
        ERC165Base__InvalidInterfaceId(ERC165Base__InvalidInterfaceId),
    ...
    impl ::ethers::core::abi::AbiDecode for SolidStateDiamondErrors {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded) = <ERC165Base__InvalidInterfaceId as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ERC165Base__InvalidInterfaceId(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for SolidStateDiamondErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::ERC165Base__InvalidInterfaceId(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::ethers::contract::ContractRevert for SolidStateDiamondErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector
                    == <ERC165Base__InvalidInterfaceId as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ if selector
    ...
    impl ::core::fmt::Display for SolidStateDiamondErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::DiamondWritable__InvalidInitializationParameters(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for SolidStateDiamondErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<DiamondWritable__InvalidInitializationParameters>
    for SolidStateDiamondErrors {
    ...
    impl ::core::convert::From<ERC165Base__InvalidInterfaceId>
    for SolidStateDiamondErrors {
        fn from(value: ERC165Base__InvalidInterfaceId) -> Self {
            Self::ERC165Base__InvalidInterfaceId(value)
        }
    }
    impl ::core::convert::From<Ownable__NotOwner> for SolidStateDiamondErrors {
        fn from(value: Ownable__NotOwner) -> Self {
            Self::Ownable__NotOwner(value)
        }
    }
    impl ::core::convert::From<Ownable__NotTransitiveOwner> for SolidStateDiamondErrors {
    ...
    pub enum SolidStateDiamondEvents {
        DiamondCutFilter(DiamondCutFilter),
        OwnershipTransferredFilter(OwnershipTransferredFilter),
    }
    impl ::ethers::contract::EthLogDecode for SolidStateDiamondEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = DiamondCutFilter::decode_log(log) {
                return Ok(SolidStateDiamondEvents::DiamondCutFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(SolidStateDiamondEvents::OwnershipTransferredFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for SolidStateDiamondEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DiamondCutFilter> for SolidStateDiamondEvents {
        fn from(value: DiamondCutFilter) -> Self {
            Self::DiamondCutFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for SolidStateDiamondEvents {
    ...
    pub enum SolidStateDiamondCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for SolidStateDiamondCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for SolidStateDiamondCalls {
    ...
    impl ::core::fmt::Display for SolidStateDiamondCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AcceptOwnershipCall> for SolidStateDiamondCalls {
        fn from(value: AcceptOwnershipCall) -> Self {
            Self::AcceptOwnership(value)
        }
    }
    impl ::core::convert::From<DiamondCutCall> for SolidStateDiamondCalls {
        fn from(value: DiamondCutCall) -> Self {
            Self::DiamondCut(value)
        }
    }
    impl ::core::convert::From<FacetAddressCall> for SolidStateDiamondCalls {
        fn from(value: FacetAddressCall) -> Self {
            Self::FacetAddress(value)
        }
    }
    impl ::core::convert::From<FacetAddressesCall> for SolidStateDiamondCalls {
        fn from(value: FacetAddressesCall) -> Self {
            Self::FacetAddresses(value)
        }
    }
    impl ::core::convert::From<FacetFunctionSelectorsCall> for SolidStateDiamondCalls {
        fn from(value: FacetFunctionSelectorsCall) -> Self {
            Self::FacetFunctionSelectors(value)
        }
    }
    impl ::core::convert::From<FacetsCall> for SolidStateDiamondCalls {
        fn from(value: FacetsCall) -> Self {
            Self::Facets(value)
        }
    }
    impl ::core::convert::From<GetFallbackAddressCall> for SolidStateDiamondCalls {
        fn from(value: GetFallbackAddressCall) -> Self {
            Self::GetFallbackAddress(value)
        }
    }
    impl ::core::convert::From<NomineeOwnerCall> for SolidStateDiamondCalls {
        fn from(value: NomineeOwnerCall) -> Self {
            Self::NomineeOwner(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for SolidStateDiamondCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<SetFallbackAddressCall> for SolidStateDiamondCalls {
        fn from(value: SetFallbackAddressCall) -> Self {
            Self::SetFallbackAddress(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for SolidStateDiamondCalls {
        fn from(value: SupportsInterfaceCall) -> Self {
            Self::SupportsInterface(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for SolidStateDiamondCalls {
