...
pub mod i_uniswap_v2_pair {
    ...
    impl<M: ::ethers::providers::Middleware> IUniswapV2Pair<M> {
        ...
        pub fn get_reserves(
            ...
            M,
            (::ethers::core::types::U256, ::ethers::core::types::U256, u32),
        > {
            self.0
    ...
    pub struct BurnCall(pub ::ethers::core::types::Address);
    ...
    impl ::core::convert::From<TokensCall> for IUniswapV2PairCalls {
