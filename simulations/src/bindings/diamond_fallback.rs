...
pub mod diamond_fallback {
    ...
    pub static DIAMONDFALLBACK_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct DiamondFallback<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for DiamondFallback<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for DiamondFallback<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for DiamondFallback<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for DiamondFallback<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(DiamondFallback))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> DiamondFallback<M> {
    ...
    pub enum DiamondFallbackErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for DiamondFallbackErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for DiamondFallbackErrors {
    ...
    impl ::ethers::contract::ContractRevert for DiamondFallbackErrors {
    ...
    impl ::core::fmt::Display for DiamondFallbackErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for DiamondFallbackErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<Ownable__NotOwner> for DiamondFallbackErrors {
        fn from(value: Ownable__NotOwner) -> Self {
            Self::Ownable__NotOwner(value)
        }
    }
    impl ::core::convert::From<Ownable__NotTransitiveOwner> for DiamondFallbackErrors {
    ...
    pub enum DiamondFallbackCalls {
        GetFallbackAddress(GetFallbackAddressCall),
        SetFallbackAddress(SetFallbackAddressCall),
    }
    impl ::ethers::core::abi::AbiDecode for DiamondFallbackCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for DiamondFallbackCalls {
    ...
    impl ::core::fmt::Display for DiamondFallbackCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::GetFallbackAddress(element) => {
                    ::core::fmt::Display::fmt(element, f)
    ...
    impl ::core::convert::From<GetFallbackAddressCall> for DiamondFallbackCalls {
        fn from(value: GetFallbackAddressCall) -> Self {
            Self::GetFallbackAddress(value)
        }
    }
    impl ::core::convert::From<SetFallbackAddressCall> for DiamondFallbackCalls {
