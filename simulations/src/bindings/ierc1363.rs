...
pub mod ierc1363 {
    ...
    pub static IERC1363_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    ...
    impl<M> ::core::fmt::Debug for IERC1363<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IERC1363)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for IERC1363Calls {
        fn decode(
            ...
            if let Ok(decoded) = <ApproveAndCallCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ApproveAndCall(decoded));
            }
            if let Ok(decoded) = <ApproveAndCallWithSpenderAndValueCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <TransferAndCallCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::TransferAndCall(decoded));
            }
            if let Ok(decoded) = <TransferAndCallWithToAndValueCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <TransferFromAndCallCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
