pub use ierc2535_diamond_loupe::*;
...
pub mod ierc2535_diamond_loupe {
    ...
    pub static IERC2535DIAMONDLOUPE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct IERC2535DiamondLoupe<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IERC2535DiamondLoupe<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IERC2535DiamondLoupe<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IERC2535DiamondLoupe<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IERC2535DiamondLoupe<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IERC2535DiamondLoupe))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IERC2535DiamondLoupe<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    IERC2535DIAMONDLOUPE_ABI.clone(),
                    client,
                ),
            )
        }
    ...
    impl ::ethers::core::abi::AbiEncode for IERC2535DiamondLoupeCalls {
    ...
    impl ::core::fmt::Display for IERC2535DiamondLoupeCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
