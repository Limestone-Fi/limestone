...
pub mod i_ownable {
    ...
    impl<M> ::core::fmt::Debug for IOwnable<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IOwnable)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for IOwnableErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IOwnableErrors {
    ...
    impl ::ethers::contract::ContractRevert for IOwnableErrors {
    ...
    impl ::core::fmt::Display for IOwnableErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for IOwnableErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<Ownable__NotOwner> for IOwnableErrors {
        fn from(value: Ownable__NotOwner) -> Self {
            Self::Ownable__NotOwner(value)
        }
    }
    impl ::core::convert::From<Ownable__NotTransitiveOwner> for IOwnableErrors {
    ...
    impl ::core::fmt::Display for IOwnableCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<OwnerCall> for IOwnableCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for IOwnableCalls {
