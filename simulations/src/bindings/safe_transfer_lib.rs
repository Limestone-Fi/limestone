...
pub mod safe_transfer_lib {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("Permit2AmountOverflow"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                ...
                (
                    ::std::borrow::ToOwned::to_owned("Permit2Failed"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned("Permit2Failed"),
                            inputs: ::std::vec![],
                        },
                    ],
                ),
    ...
    ///Custom Error type `Permit2AmountOverflow` with signature `Permit2AmountOverflow()` and selector `0x8757f0fd`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(name = "Permit2AmountOverflow", abi = "Permit2AmountOverflow()")]
    pub struct Permit2AmountOverflow;
    ///Custom Error type `Permit2Failed` with signature `Permit2Failed()` and selector `0x6b836e6b`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(name = "Permit2Failed", abi = "Permit2Failed()")]
    ...
    impl ::ethers::core::abi::AbiDecode for SafeTransferLibErrors {
        fn decode(
            ...
            if let Ok(decoded) = <ApproveFailed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <Permit2AmountOverflow as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Permit2AmountOverflow(decoded));
            }
            if let Ok(decoded) = <Permit2Failed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Permit2Failed(decoded));
            }
            ...
            if let Ok(decoded) = <TransferFromFailed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for SafeTransferLibErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::Permit2AmountOverflow(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::Permit2Failed(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::ethers::contract::ContractRevert for SafeTransferLibErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector
                    == <Permit2AmountOverflow as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ if selector
                    == <Permit2Failed as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ if selector
    ...
    impl ::core::fmt::Display for SafeTransferLibErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::Permit2Failed(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<Permit2AmountOverflow> for SafeTransferLibErrors {
        fn from(value: Permit2AmountOverflow) -> Self {
            Self::Permit2AmountOverflow(value)
        }
    }
    impl ::core::convert::From<Permit2Failed> for SafeTransferLibErrors {
        fn from(value: Permit2Failed) -> Self {
            Self::Permit2Failed(value)
        }
    }
