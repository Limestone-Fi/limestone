...
pub mod i_safe_ownable {
    ...
    pub static ISAFEOWNABLE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct ISafeOwnable<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for ISafeOwnable<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for ISafeOwnable<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for ISafeOwnable<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for ISafeOwnable<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(ISafeOwnable))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> ISafeOwnable<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for ISafeOwnableErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ISafeOwnableErrors {
    ...
    impl ::ethers::contract::ContractRevert for ISafeOwnableErrors {
    ...
    impl ::core::fmt::Display for ISafeOwnableErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for ISafeOwnableErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<Ownable__NotOwner> for ISafeOwnableErrors {
        fn from(value: Ownable__NotOwner) -> Self {
            Self::Ownable__NotOwner(value)
        }
    }
    impl ::core::convert::From<Ownable__NotTransitiveOwner> for ISafeOwnableErrors {
        fn from(value: Ownable__NotTransitiveOwner) -> Self {
            Self::Ownable__NotTransitiveOwner(value)
        }
    }
    impl ::core::convert::From<SafeOwnable__NotNomineeOwner> for ISafeOwnableErrors {
    ...
    pub enum ISafeOwnableCalls {
        AcceptOwnership(AcceptOwnershipCall),
        NomineeOwner(NomineeOwnerCall),
        Owner(OwnerCall),
        TransferOwnership(TransferOwnershipCall),
    }
    impl ::ethers::core::abi::AbiDecode for ISafeOwnableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for ISafeOwnableCalls {
    ...
    impl ::core::fmt::Display for ISafeOwnableCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AcceptOwnershipCall> for ISafeOwnableCalls {
        fn from(value: AcceptOwnershipCall) -> Self {
            Self::AcceptOwnership(value)
        }
    }
    impl ::core::convert::From<NomineeOwnerCall> for ISafeOwnableCalls {
        fn from(value: NomineeOwnerCall) -> Self {
            Self::NomineeOwner(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for ISafeOwnableCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for ISafeOwnableCalls {
