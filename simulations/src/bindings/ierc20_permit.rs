...
pub mod ierc20_permit {
    ...
    impl ::ethers::core::abi::AbiDecode for IERC20PermitErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IERC20PermitErrors {
    ...
    impl ::ethers::contract::ContractRevert for IERC20PermitErrors {
    ...
    impl ::core::fmt::Display for IERC20PermitErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::ERC20Permit__ExpiredDeadline(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for IERC20PermitErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<ERC20Permit__ExpiredDeadline> for IERC20PermitErrors {
        fn from(value: ERC20Permit__ExpiredDeadline) -> Self {
            Self::ERC20Permit__ExpiredDeadline(value)
        }
    }
    impl ::core::convert::From<ERC20Permit__InvalidSignature> for IERC20PermitErrors {
