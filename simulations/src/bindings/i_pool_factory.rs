...
pub mod i_pool_factory {
    ...
    pub static IPOOLFACTORY_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct IPoolFactory<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IPoolFactory<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IPoolFactory<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IPoolFactory<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IPoolFactory<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IPoolFactory))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IPoolFactory<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for IPoolFactoryErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IPoolFactoryErrors {
    ...
    impl ::ethers::contract::ContractRevert for IPoolFactoryErrors {
    ...
    impl ::core::fmt::Display for IPoolFactoryErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for IPoolFactoryErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<FeeInvalid> for IPoolFactoryErrors {
        fn from(value: FeeInvalid) -> Self {
            Self::FeeInvalid(value)
        }
    }
    impl ::core::convert::From<FeeTooHigh> for IPoolFactoryErrors {
        fn from(value: FeeTooHigh) -> Self {
            Self::FeeTooHigh(value)
        }
    }
    impl ::core::convert::From<InvalidPool> for IPoolFactoryErrors {
        fn from(value: InvalidPool) -> Self {
            Self::InvalidPool(value)
        }
    }
    impl ::core::convert::From<NotFeeManager> for IPoolFactoryErrors {
        fn from(value: NotFeeManager) -> Self {
            Self::NotFeeManager(value)
        }
    }
    impl ::core::convert::From<NotPauser> for IPoolFactoryErrors {
        fn from(value: NotPauser) -> Self {
            Self::NotPauser(value)
        }
    }
    impl ::core::convert::From<NotVoter> for IPoolFactoryErrors {
        fn from(value: NotVoter) -> Self {
            Self::NotVoter(value)
        }
    }
    impl ::core::convert::From<PoolAlreadyExists> for IPoolFactoryErrors {
        fn from(value: PoolAlreadyExists) -> Self {
            Self::PoolAlreadyExists(value)
        }
    }
    impl ::core::convert::From<SameAddress> for IPoolFactoryErrors {
        fn from(value: SameAddress) -> Self {
            Self::SameAddress(value)
        }
    }
    impl ::core::convert::From<ZeroAddress> for IPoolFactoryErrors {
        fn from(value: ZeroAddress) -> Self {
            Self::ZeroAddress(value)
        }
    }
    impl ::core::convert::From<ZeroFee> for IPoolFactoryErrors {
    ...
    impl ::ethers::contract::EthLogDecode for IPoolFactoryEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = PoolCreatedFilter::decode_log(log) {
                return Ok(IPoolFactoryEvents::PoolCreatedFilter(decoded));
            }
            if let Ok(decoded) = SetCustomFeeFilter::decode_log(log) {
                return Ok(IPoolFactoryEvents::SetCustomFeeFilter(decoded));
            }
            if let Ok(decoded) = SetFeeManagerFilter::decode_log(log) {
                return Ok(IPoolFactoryEvents::SetFeeManagerFilter(decoded));
            }
            if let Ok(decoded) = SetPauseStateFilter::decode_log(log) {
                return Ok(IPoolFactoryEvents::SetPauseStateFilter(decoded));
            }
            if let Ok(decoded) = SetPauserFilter::decode_log(log) {
                return Ok(IPoolFactoryEvents::SetPauserFilter(decoded));
            }
            if let Ok(decoded) = SetVoterFilter::decode_log(log) {
                return Ok(IPoolFactoryEvents::SetVoterFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for IPoolFactoryEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<PoolCreatedFilter> for IPoolFactoryEvents {
        fn from(value: PoolCreatedFilter) -> Self {
            Self::PoolCreatedFilter(value)
        }
    }
    impl ::core::convert::From<SetCustomFeeFilter> for IPoolFactoryEvents {
        fn from(value: SetCustomFeeFilter) -> Self {
            Self::SetCustomFeeFilter(value)
        }
    }
    impl ::core::convert::From<SetFeeManagerFilter> for IPoolFactoryEvents {
        fn from(value: SetFeeManagerFilter) -> Self {
            Self::SetFeeManagerFilter(value)
        }
    }
    impl ::core::convert::From<SetPauseStateFilter> for IPoolFactoryEvents {
        fn from(value: SetPauseStateFilter) -> Self {
            Self::SetPauseStateFilter(value)
        }
    }
    impl ::core::convert::From<SetPauserFilter> for IPoolFactoryEvents {
        fn from(value: SetPauserFilter) -> Self {
            Self::SetPauserFilter(value)
        }
    }
    impl ::core::convert::From<SetVoterFilter> for IPoolFactoryEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for IPoolFactoryCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for IPoolFactoryCalls {
    ...
    impl ::core::fmt::Display for IPoolFactoryCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ImplementationCall> for IPoolFactoryCalls {
        fn from(value: ImplementationCall) -> Self {
            Self::Implementation(value)
        }
    }
    impl ::core::convert::From<IsPausedCall> for IPoolFactoryCalls {
        fn from(value: IsPausedCall) -> Self {
            Self::IsPaused(value)
        }
    }
    impl ::core::convert::From<IsPoolCall> for IPoolFactoryCalls {
        fn from(value: IsPoolCall) -> Self {
            Self::IsPool(value)
        }
    }
    impl ::core::convert::From<SetCustomFeeCall> for IPoolFactoryCalls {
        fn from(value: SetCustomFeeCall) -> Self {
            Self::SetCustomFee(value)
        }
    }
    impl ::core::convert::From<SetFeeCall> for IPoolFactoryCalls {
        fn from(value: SetFeeCall) -> Self {
            Self::SetFee(value)
        }
    }
    impl ::core::convert::From<SetFeeManagerCall> for IPoolFactoryCalls {
        fn from(value: SetFeeManagerCall) -> Self {
            Self::SetFeeManager(value)
        }
    }
    impl ::core::convert::From<SetPauseStateCall> for IPoolFactoryCalls {
        fn from(value: SetPauseStateCall) -> Self {
            Self::SetPauseState(value)
        }
    }
    impl ::core::convert::From<SetPauserCall> for IPoolFactoryCalls {
        fn from(value: SetPauserCall) -> Self {
            Self::SetPauser(value)
        }
    }
    impl ::core::convert::From<SetVoterCall> for IPoolFactoryCalls {
        fn from(value: SetVoterCall) -> Self {
            Self::SetVoter(value)
        }
    }
    impl ::core::convert::From<VoterCall> for IPoolFactoryCalls {
