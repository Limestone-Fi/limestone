...
pub mod safe_ownable_internal {
    ...
    pub static SAFEOWNABLEINTERNAL_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct SafeOwnableInternal<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for SafeOwnableInternal<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for SafeOwnableInternal<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for SafeOwnableInternal<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for SafeOwnableInternal<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(SafeOwnableInternal))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> SafeOwnableInternal<M> {
    ...
    pub enum SafeOwnableInternalErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for SafeOwnableInternalErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for SafeOwnableInternalErrors {
    ...
    impl ::ethers::contract::ContractRevert for SafeOwnableInternalErrors {
    ...
    impl ::core::fmt::Display for SafeOwnableInternalErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for SafeOwnableInternalErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<Ownable__NotOwner> for SafeOwnableInternalErrors {
        fn from(value: Ownable__NotOwner) -> Self {
            Self::Ownable__NotOwner(value)
        }
    }
    impl ::core::convert::From<Ownable__NotTransitiveOwner>
    for SafeOwnableInternalErrors {
