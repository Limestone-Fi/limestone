...
pub mod erc721 {
    ...
    impl ::ethers::core::abi::AbiDecode for ERC721Errors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ERC721Errors {
    ...
    impl ::ethers::contract::ContractRevert for ERC721Errors {
    ...
    impl ::core::fmt::Display for ERC721Errors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::AccountBalanceOverflow(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for ERC721Errors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<AccountBalanceOverflow> for ERC721Errors {
        fn from(value: AccountBalanceOverflow) -> Self {
            Self::AccountBalanceOverflow(value)
        }
    }
    impl ::core::convert::From<BalanceQueryForZeroAddress> for ERC721Errors {
        fn from(value: BalanceQueryForZeroAddress) -> Self {
            Self::BalanceQueryForZeroAddress(value)
        }
    }
    impl ::core::convert::From<NotOwnerNorApproved> for ERC721Errors {
        fn from(value: NotOwnerNorApproved) -> Self {
            Self::NotOwnerNorApproved(value)
        }
    }
    impl ::core::convert::From<TokenAlreadyExists> for ERC721Errors {
        fn from(value: TokenAlreadyExists) -> Self {
            Self::TokenAlreadyExists(value)
        }
    }
    impl ::core::convert::From<TokenDoesNotExist> for ERC721Errors {
        fn from(value: TokenDoesNotExist) -> Self {
            Self::TokenDoesNotExist(value)
        }
    }
    impl ::core::convert::From<TransferFromIncorrectOwner> for ERC721Errors {
        fn from(value: TransferFromIncorrectOwner) -> Self {
            Self::TransferFromIncorrectOwner(value)
        }
    }
    impl ::core::convert::From<TransferToNonERC721ReceiverImplementer> for ERC721Errors {
        fn from(value: TransferToNonERC721ReceiverImplementer) -> Self {
            Self::TransferToNonERC721ReceiverImplementer(value)
        }
    }
    impl ::core::convert::From<TransferToZeroAddress> for ERC721Errors {
