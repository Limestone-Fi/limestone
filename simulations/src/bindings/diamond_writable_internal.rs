pub use diamond_writable_internal::*;
...
pub mod diamond_writable_internal {
    ...
    pub static DIAMONDWRITABLEINTERNAL_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct DiamondWritableInternal<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for DiamondWritableInternal<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for DiamondWritableInternal<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for DiamondWritableInternal<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for DiamondWritableInternal<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(DiamondWritableInternal))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> DiamondWritableInternal<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    DIAMONDWRITABLEINTERNAL_ABI.clone(),
                    client,
                ),
            )
        }
    ...
    pub enum DiamondWritableInternalErrors {
        DiamondWritable__InvalidInitializationParameters(
            DiamondWritable__InvalidInitializationParameters,
        ),
        DiamondWritable__RemoveTargetNotZeroAddress(
    ...
    impl ::ethers::core::abi::AbiDecode for DiamondWritableInternalErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for DiamondWritableInternalErrors {
    ...
    impl ::ethers::contract::ContractRevert for DiamondWritableInternalErrors {
    ...
    impl ::core::fmt::Display for DiamondWritableInternalErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::DiamondWritable__InvalidInitializationParameters(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for DiamondWritableInternalErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<DiamondWritable__InvalidInitializationParameters>
    for DiamondWritableInternalErrors {
