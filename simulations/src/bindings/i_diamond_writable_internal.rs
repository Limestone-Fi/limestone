pub use i_diamond_writable_internal::*;
...
pub mod i_diamond_writable_internal {
    ...
    pub static IDIAMONDWRITABLEINTERNAL_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct IDiamondWritableInternal<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IDiamondWritableInternal<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IDiamondWritableInternal<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IDiamondWritableInternal<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IDiamondWritableInternal<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IDiamondWritableInternal))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IDiamondWritableInternal<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    IDIAMONDWRITABLEINTERNAL_ABI.clone(),
                    client,
                ),
            )
        }
    ...
    for IDiamondWritableInternal<M> {
    ...
    pub enum IDiamondWritableInternalErrors {
        DiamondWritable__InvalidInitializationParameters(
            DiamondWritable__InvalidInitializationParameters,
        ),
        DiamondWritable__RemoveTargetNotZeroAddress(
    ...
    impl ::ethers::core::abi::AbiDecode for IDiamondWritableInternalErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IDiamondWritableInternalErrors {
    ...
    impl ::ethers::contract::ContractRevert for IDiamondWritableInternalErrors {
    ...
    impl ::core::fmt::Display for IDiamondWritableInternalErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::DiamondWritable__InvalidInitializationParameters(element) => {
    ...
    for IDiamondWritableInternalErrors {
